                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div className="flex items-center gap-8">
                        <div className="relative">
                            ...
                            <label className="absolute bottom-0 right-0 bg-[#0055A5] p-2 rounded-full text-white cursor-pointer hover:bg-[#004080] shadow-md transition-colors">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0055A5] focus:border-[#0055A5] outline-none transition-all"
                            />
                        </div>
                        <div>
                    ...
                    <div className="pt-4 flex justify-end">
                        <button
                            type="submit"
                            disabled={saving}
                            className="bg-[#0055A5] hover:bg-[#004080] text-white font-bold py-2.5 px-6 rounded-lg transition-colors shadow-sm disabled:opacity-70 flex items-center gap-2"
                        >
